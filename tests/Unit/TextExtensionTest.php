...
final class TextExtensionTest extends \Xefi\Faker\EnUs\Tests\Unit\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $textExtension = new \Xefi\Faker\EnUs\Extensions\TextExtension(new \Random\Randomizer());
