...
final class ColorsExtensionTest extends \Xefi\Faker\EnUs\Tests\Unit\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $colorsExtension = new \Xefi\Faker\EnUs\Extensions\ColorsExtension(new \Random\Randomizer());
